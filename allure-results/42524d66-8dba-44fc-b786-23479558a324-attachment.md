...
```ts
  ...
  10 |     private swagLagLogo:Locator;
  ...
  21 |         this.swagLagLogo = page.locator('.login_logo');
  22 |     }
  23 | 
  ...
  32 |         return await this.swagLagLogo.isVisible();
  33 |     }
  34 | 
  35 |     async getErrorMessage(): Promise<string | null> {
> 36 |         return await this.errorMessage.innerText();
     |                                        ^ Error: locator.innerText: Test ended.
  37 |     }
  38 | }
  39 | 
