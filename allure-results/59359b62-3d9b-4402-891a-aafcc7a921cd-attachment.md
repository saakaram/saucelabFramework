...
Rejected to value: [Error: locator.textContent: Test timeout of 30000ms exceeded.
Call log:
...
> 22 |       await expect(loginPage.getErrorMessage()).resolves.toContain('Epic sadface: Sorry, this user has been locked out.');
     |                                                          ^ Error: expect(received).resolves.toContain()
  23 |     }); 
  24 | 
